...
public class OrderController {
   ...
   /**
	...
	public @ResponseBody Map<String, Object> getOrderInMine(@RequestParam String phoneId,Short status,Integer page,Integer limit){
		Map<String, Object> map=new HashMap<String, Object>();
	...
	public @ResponseBody Map<String , Object> getUserOrder(@RequestParam String phoneId,@RequestParam Integer campusId,Integer limit ,Integer page){
		Map<String, Object> map=new HashMap<String, Object>();
